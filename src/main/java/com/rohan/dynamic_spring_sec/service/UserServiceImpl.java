...
import com.rohan.dynamic_spring_sec.repository.UserDao;
...
public class UserServiceImpl implements UserDetailsService, UserService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new com.rohan.dynamic_spring_sec.dto.User(String.valueOf(user.getId()), user.getUsername(), user.getPassword(), getAuthority());
    }
